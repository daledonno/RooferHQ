...
const MapboxRouteMap = ({ officeLocation, postcodes, onMapLoad }) => {
    ...
    mapContainer.innerHTML = `
      <div class="w-full h-full bg-gray-100 rounded-lg flex flex-col items-center justify-center p-6">
        <div class="text-center">
          ...
          <h3 class="text-xl font-semibold text-gray-800 mb-2">Route Planning (Mapbox)</h3>
  ...
  useEffect(() => {
    ...
    setError('Mapbox access token required. Using fallback display.');
